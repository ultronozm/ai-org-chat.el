...
* Usage
When you want to ask the AI something, do =M-x ai-org-chat-new=.  This will create a new file in the specified directory ("~/gpt" by default).  If the region was active, then it is quoted in the new buffer.  Here's what it looks like:
